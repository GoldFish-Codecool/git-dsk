...
class Game:
    def __init__(self):
        ...
        self.board = Board()
        self.AI = True  # True: Player vs AI mode, False: Player vs Player mode.
        self.player1 = None
        self.player2 = None
    ...
    # Make the move
        ...
        if self.board.board[move] == '•':
            ...
            # If no winner check for draw
                ...
                self.leadership_board.save_score(self.player1.name, 1) if not self.active_player.AI else None
                self.leadership_board.save_score(self.player2.name, 1) if not self.active_player.AI else None
                self.status = False
                return
            else:
                # Switch players
